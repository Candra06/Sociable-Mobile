                  ...
                  child: Stack(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(71), color: Colors.grey),
                        child: Row(
                          children: [
                            Container(
                              width: 0.3 * 278,
                              height: 5,
                              // margin: EdgeInsets.only(left: 34,right: 34,top: 39),
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(71), color: Colors.blue),
                            ),
                          ],
                        ),
                      ),
                      Container(
                          ...
                          child: Center(
                            child: Text(
                              "Apakah anda adalah seorang yang takut pada figur otoritas?",
